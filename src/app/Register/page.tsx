...
export default function Register() {
  return (
    <div className=' h-[750px]  flex items-center  justify-center background'>

      <div className='w-[450px] glass '>
        <div className=' text-center  '>
          <h2 className='text-2xl pt-4 font-semibold text-black'>Register</h2>
        </div>
        <form className='my-2' >
          <div className='flex flex-col justify-center items-center'>
            <div className='flex w-[350px] justify-between border-b-black border-b-2 mx-5 my-7 py-1 flex-row '>
              <input
                type="text"
