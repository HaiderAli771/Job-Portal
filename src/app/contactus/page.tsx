    ...
    return (
        <>
            <div className="bg-black">
                <Header />
                <h1 className="text-white font-bold text-[30px] md:text-[60px] text-center pt-16 pb-16">Contact Us</h1>
            </div>
                ...
                <div className=" md:p-8 p-2 flex flex-col  xl:flex-row">
                    <div className="md:w-1/2  p-2 md:p-8">
                        ...
                        <div className='flex flex-col md:flex-row justify-between'>
                            ...
                            <div className='md:pl-20 xl:w-[285px]'>
                                <Timing descritionClassName=' text-[16px] font-normal text-green-500 md:w-[200px]' className='text-xl font-semibold mb-2' title='Opening hours' description='Mon - Fri: 10AM - 10PM' ImgSrc='/clock.png' />
                                <Timing descritionClassName=' text-[16px] font-normal text-green-500 md:w-[200px]' className='text-xl font-semibold mb-2' title='Office' description='19 North Road Piscataway, NY 08854' ImgSrc='/map.png' />
                            </div>
                        </div>
                    </div>
                    <div className="md:w-[600px] bg-blue-50 p-2 md:p-8 rounded-lg">
                        ...
                        <form className="md:space-y-4">
                            <div className="md:flex md:flex-row md:items-baseline flex-col justify-between">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className=" p-3 border w-full md:w-60 border-gray-300 rounded-lg"
                                    />
                                </div>
                                <div>
                                    <h1 className='pl-1 pb-2 pt-2'>Last Name</h1>
                                    <input
                                        type="text"
                            ...
                            <div>
                                <h1 className='pl-1 pb-2 pt-2'>Email Address</h1>
                                <input
                                    type="email"
                            ...
                            <div>
                                <h1 className='pl-1 pb-2 pt-2'>Message</h1>
                                <textarea
