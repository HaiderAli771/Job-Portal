  ...
  return (
    <nav className="bg-[#EBF5F4] md:w-[350px]  rounded-2xl mx-2 md:pb-12 pb-14 pr-3  md:ml-11 md:mt-4">
      <div className="flex flex-col ml-6 pt-8 md:ml-7 items-center gap-4  "> 
        <h1 className="font-semibold  text-md md:text-xl">Search by Job Title</h1>
        <div className="flex bg-white gap-3 w-[262px] md:w-[270px] rounded-xl py-2  pl-1">
          <Image src="/search.svg" alt="search" width={20} height={20} />
          <input  className=" outline-none md:text-normal text-sm" type="text" placeholder="Search by Job Title" />
        </div>
      </div>
      <div className="flex flex-col md:ml-7 gap-3 items-center ml-6 mt-4">
        ...
        <div className="flex bg-white gap-3 w-[264px] md:w-[270px] rounded-xl py-2 pl-1">
          ...
          <input className=" outline-none md:text-normal text-sm " type="text" placeholder="Chrome City" />
        </div>
      </div>

      <div className=" md:ml-7 ml-7 mt-3 flex flex-col justify-center items-center " >
        <h1 className="font-semibold md:text-xl md:ml-1 text-md md:mt-3 text-sm underline ">Category</h1>
      ...
      <p className="font-semibold md:text-xl text-sm underline   ">Job Type</p>
      <Bar
      ...
      <div className="ml-7 mt-3 flex flex-col justify-center items-center">
      <p className="font-semibold md:text-xl text-sm underline">Date Posted</p>
      ...
      <Bar
           ...
           /> 
      <Bar
           className=" gap-[118px] m-2"
           heading="Last hour "
           /> 
      <Bar
           className=" gap-[98px] m-2"
      ...
      <Bar
           ...
           /> 
      <Bar
           className=" gap-[96px] m-2"
           heading="Last 30 days"
           /> 
      </div>
      <SalarySlider />
      <p className="font-semibold md:ml-7 text-center  mt-3 md:mb-6 text-md underline md:text-2xl ">Tags:</p>
