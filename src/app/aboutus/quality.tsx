        ...
        <>
            <div className="flex flex-col lg:flex-col xl:flex-row  md:justify-center gap-10">
                ...
                <div className=" flex flex-col items-center justify-center ">
                    <SectionHeader descritionClassName=' text-[16px] pr-5 pl-5 font-normal md:w-[511px] pb-6' className='md:w-[471px] text-[30px] text-center md:text-ellipsis md:text-[40px] font-bold pl-2 pr-2 pb-6 justify-center' title='We&apos;re Only Working With The Best' description='Ultricies purus dolor viverra mi laoreet at cursus justo. Ultrices purus diam egestas amet faucibus tempor blandit.' />
