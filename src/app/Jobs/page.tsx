      ...
      <div className="flex flex-col lg:flex-row md:mx-2 mt-4 gap-2 ">
        <div className="flex flex-col items-center gap-5">
          ...
          <div className="text-black ">
            <SectionHeader className="absolute pl-[34px] pt-5 gap-3 md:pl-20 " h1ClassName="text-white font-bold text-3xl tracking-wider" h1="WE ARE HIRING" descritionClassName="font-noramal  text-xl  text-white " description="Apply Today!" />
        ...
        <div className="mt-5 md:mr-4 w-full ">
          <div className="text-[#6C757D] flex md:flex-row flex-col gap-5 text-center md:justify-between justify-center">
            <p > Showing 6-6 of 10 results</p>
            <Link className="md:rounded-md px-2 py-1 mx-4 md:mx-0 md:border-[#6C757D] border-teal-500 rounded-3xl md:border border-2" href="/sort by latest" >Sort by Latest</Link>
          </div>
          <div>
            <JobCard
              timeAgo="24 min ago"
