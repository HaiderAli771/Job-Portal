      ...
      <div className="flex flex-col lg:flex-row  md:mx-2 mt-4 gap-2 ">
        <div className="flex flex-col items-center gap-5">
          ...
          <div className="text-black ">
           <SectionHeader className="absolute pl-[34px] pt-5 gap-3 md:pl-20 "  h1ClassName="text-white font-bold text-md md:text-3xl tracking-wider" h1="WE ARE HIRING" descritionClassName="font-noramal  md:text-xl text-sm  text-white " description="Apply Today!"   />
          <Image className=" md:pl-10 items-center md:w-[396px] px-3   " src={"/img.svg"} alt="img" width={327} height={80} />
          </div>
        </div>
        <div className="mt-5 md:mr-4 w-full ">
          <div className="text-[#6C757D] md:text-lg text-sm flex md:flex-row flex-col gap-5 text-center md:justify-between justify-center">
            ...
            <Link className="md:rounded-md px-2 py-1 mx-12 md:mx-0 md:border-[#6C757D] border-teal-500 rounded-3xl md:border border-2" href="/sort by latest" >Sort by Latest</Link>
            </div>
          <div>
            <JobCard
              timeAgo="24 min ago"
          ...
          <div className="flex md:flex-row flex-col  gap-4 jsutify-center md:justify-evenly md:ml-0 md:gap-[350px] mb-11 items-center mt-20 md:h-10 ">
            <div className="flex gap-8 md:ml-0 ">
              <div className="rounded-md w-10 h-10 text-sm md:text-md text-center p-2 text-white  bg-[#309689] ">1</div>
              <div className="rounded-md w-10 h-10 text-center text-sm  md:text-md p-2 text-[#6C757D] border-2 border-[#309689] ">2</div>
            </div>
