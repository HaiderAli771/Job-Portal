...
const Footer = () => {
  return (
    <footer className="bg-black text-white py-8container mx-auto px-4 pt-[30px]">
      <div className="flex md:pl-0 md:pr-0 pl-2 pr-2 flex-col md:text-start text-center md:flex-row  ">
        <div className="w-full sm:w-1/4 mb-6 sm:mb-0">
          <SectionHeader
            descritionClassName="text-[15px] mt-4 font-normal"
            className="text-[20px] font-extrabold "
            title="Job"
            description="Quis enim pellentesque viverra tellus eget malesuada facilisis. Congue nibh vivamus aliquet nunc mauris d..."
          />
        </div>
        <div className="flex flex-col items-center w-full sm:w-1/4 mb-6 sm:mb-0">
          ...
          <div className="mt-4 flex flex-col gap-3">
            <Link className="text-sm" href="/aboutus">
              About Us
            </Link>
            <Link className="text-sm" href="/contactus">
              Our Team
            </Link>
        ...
        <div className="w-full sm:w-1/4 mb-6 sm:mb-0">
          <SectionHeader
            descritionClassName="text-sm mt-4 font-normal gap-0"
            className="text-lg font-bold gap-0"
            title="Newsletter"
            description="Eu nunc pretium vitae platea. Non netus elementum vulputate"
          />
