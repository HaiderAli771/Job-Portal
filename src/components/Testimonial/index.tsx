...
const Textimonial = ({
  ...
  return (
    <div className=" leading-6 bg-white ring-2 ring-gray-200 md:ring-0 shadow-xl md:shadow-sm rounded-2xl  h-auto pb-4 md:pb-2  w-auto m-4 md:m-0  ">
      ...
      <Link
        className=" flex flex-row justify-center mx-5  items-center  rounded-2xl px-3 py-1  bg-teal-100 sm:mb-9 md:w-auto md:mx-28  md:text-normal text-sm text-[#309689]"
        href="/Jobs"
      >
        {jobs}
      </Link>
