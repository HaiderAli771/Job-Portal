  ...
  return (
    <div className="mt-[50px] rounded-xl pb-5 md:mx-0 mx-2   shadow-2xl md:pl-[22px] md:pt-6 p-6 md:pr-6">
      <div className="flex justify-between">
        <button className="text-[#2d8c7f] bg-teal-100 px-2 text-sm text-normal rounded-lg">
          {timeAgo}
        </button>
      ...
      <div className="flex justify-between md:flex-row flex-col md:items-end md:pl-0 pl-10 items-center  text-[#6C757D] mt-4 md:mt-14">
        ...
        <Link
          className="rounded-xl md:mr-0 mr-11 md:mt-0 mt-5 px-2 text-center text-sm py-1 hover:bg-[#0d5e54] bg-[#309689] text-white"
          href={"/Job-Details"}
        >
          Job Details
        </Link>
